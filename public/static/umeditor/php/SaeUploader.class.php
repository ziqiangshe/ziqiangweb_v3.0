...
class SaeUploader
{
    ...
    private function upFile()
    {
        ...
        //创建目录
        $folder = '';
        $fname = 'img/'.$this->getName() ;
        $this->fullName = 'http://ziqiangshe-ziqiangshe.stor.sinaapp.com/'.$fname;
...
//            $thumbnail = 'img/'.$this->getName();
//            $this->fullName =  $storage->upload('ziqiangshe', $thumbnail, $file['tmp_name']);
//            $is_upload = $storage->errmsg();
//            if (strpos($is_upload, 'success')) {
//                $this->stateInfo = $this->getStateInfo("MOVE");
//            } else {
//                $this->stateInfo = $this->stateMap[0];
//            }
//            $this->fullName = "http://ziqiangshe-ziqiangshe.stor.sinaapp.com/".$thumbnail;
//            $this->fileName = $thumbnail;
//            $is_upload = $storage->putObjectFile($file['tmp_name'], 'ziqiangshe', $thumbnail);
//            if ($is_upload != TRUE) {
//                $this->stateInfo = $this->getStateInfo("MOVE");
//            } else {
//                $this->stateInfo = $this->stateMap[0];
...
//        }
    ...
    {
        $stor   = new SaeStorage();
        $domain = 'ziqiangshe'; //创建的domain的名称
        $url    = NULL;
