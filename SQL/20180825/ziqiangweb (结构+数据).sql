...
(1, 'xzfff', 'wqZMQtV37/w8I', '谢泽丰', 'http://localhost/ziqiangweb_v3.0/public/upload/avatar/20180825/175b4b8d6bba854efe451ff216d26e41.jpg', '简介：\r\n\r\n   大一主要参加的比赛有武汉市内各大高校的ACM竞赛以及华为精英赛。最近参加的是理工黄页以及自强社的网站开发。掌握的编程语言是C、C++、Html5+CSS3、PHP（个人比较喜欢C++和PHP，C++的博大精深，支持多种编程方式，其中的STL更是好玩。PHP语言入门容易，功能强大，在编写脚本与后台的时候十分好用）感觉要学好一门语言或技术需要多写代码多调试，个人觉得技术学习最需要的是兴趣和愿意付出的时间。\r\n', '这一届的新生很多都开始提前学习，也有很多巨巨出现。但是小白也不要灰心（我大一时候也是纯小白）不要好高骛远，学习需要一步一个脚印，学技术更是如此。另外，不要把计算机专业和外面的培训机构相提并论，最后希望你们能加入服务队与我们一起交流。', '2018-08-02 00:00:00', 1, 'zy1502', '616973936', '13125177868', '616973936@qq.com', 15, '服务队', '队长', '1', '1', '2018-08-13 18:08:21', '2018-08-25 11:07:20'),
